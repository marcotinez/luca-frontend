...
export function WelcomeHeader({ email, totalXp, currentStreak }: WelcomeHeaderProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-card border border-border p-5 sm:p-8 mb-10 shadow-sm">
      ...
      <div className="flex flex-col md:flex-row gap-6 sm:gap-8 items-start md:items-center relative z-10">
        <div className="relative">
          <Avatar className="w-20 h-20 sm:w-24 sm:h-24 border-4 border-primary/20 shadow-xl">
            <AvatarFallback className="bg-primary/5 text-primary text-2xl sm:text-3xl font-black">
              {initials}
            </AvatarFallback>
          </Avatar>
          <div className="absolute -bottom-1 -right-1 bg-primary text-primary-foreground p-1 sm:p-1.5 rounded-full shadow-lg border-2 border-card">
        ...
        <div className="flex-1">
          <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
            ...
            <Badge variant="secondary" className="px-2 py-0.5 bg-primary/10 text-primary border-primary/20 font-bold text-[10px] sm:text-sm tracking-wide uppercase">
              NIVEL {level}
            </Badge>
          </div>
